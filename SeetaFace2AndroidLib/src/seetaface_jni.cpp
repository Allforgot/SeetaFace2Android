...
//    SeetaPointF* seetaPointF = new SeetaPointF[mFaceLandmarker->number() * 2];
//    mFaceLandmarker->mark(seetaImageData, seetaRect, seetaPointF);
//    memcpy(landmarkDoubleArray+sizeof(double), (double *)seetaPointF, sizeof(seetaPointF)*(outSize-1));
